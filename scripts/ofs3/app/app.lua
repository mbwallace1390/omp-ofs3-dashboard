...
app._uiTasks = {
    ...
    function()
        ...
        if app.uiState == app.uiStatus.mainMenu then
            invalidatePages()
        elseif app.triggers.isReady and ofs3.tasks.msp.mspQueue:isProcessed() and app.Page and app.Page.values then
...
function app.event(widget, category, value, x, y)
    ...
    if app.uiState == app.uiStatus.pages then
        ...
        if value == KEY_ENTER_LONG then
            if ofs3.app.Page.navButtons and ofs3.app.Page.navButtons.save == false then return true end
