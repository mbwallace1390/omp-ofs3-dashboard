...
local function openPage(pageIdx, title, script)
    ...
    ofs3.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.audio)@" .. " / " .. "@i18n(app.modules.settings.txt_audio_switches)@")
    ...
    for i, v in ipairs(sensorList) do
        ...
        ofs3.app.formFields[formFieldCount] = form.addSwitchField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, function()
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(settings) do ofs3.preferences.switches[key] = value end
