  ...
  ["app"] = {
    ...
    ["modules"] = {
      ...
      ["profile_governor"] = {
        ...
        ["disabled_message"] = "Governor ofs3 está deshabilitado",
      ...
      ["about"] = {
        ...
        ["opener"] = "ofs3 es un proyecto de código abierto. Contribuciones de gente que piensa como nosotros, entusiasta en ayudar a mejorar este software, es bienvenida y motivada. No hace falta que que sea un programador de élite para ayudar.",
        ["version"] = "Versión",
        ["msp_version"] = "Versión de MSP",
        ["credits"] = "Contribuyentes notables tanto para el firmware de ofs3 como a este software son: Petri Mattila, Egon Lubbers, Rob Thomson, Rob Gayle, Phil Kaighin, Robert Burrow, Keith Williams, Bertrand Songis, Venbs Zhou... y muchos más que han dedicado horas probando y proveyendo feedback! Traducción al Español: Pablo Montoreano",
      ...
      ["servos"] = {
        ...
        ["cyc_right"] = "CICL. DER",
        ["help_default_p2"] = "Los controles primarios que utilizan el mezclador de ofs3 aparecen en la sección llamada 'mezclador'.",
