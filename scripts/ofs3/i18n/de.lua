  ...
  ["app"] = {
    ...
    ["modules"] = {
      ["settings"] = {
        ...
        ["dashboard_theme_panel_global"] = "Global",
        ["dashboard_theme_panel_model"] = "Model",
      ...
      ["profile_governor"] = {
        ...
        ["disabled_message"] = "ofs3-Governor ist nicht aktiviert",
      ...
      ["about"] = {
        ...
        ["opener"] = "ofs3 ist ein Open-Source-Projekt. Beitraege von Gleichgesinnten, die daran interessiert sind, diese Software weiter zu verbessern, sind willkommen und werden ermutigt. Man muss kein Hardcore-Programmierer sein, um zu helfen.",
        ["version"] = "Version",
        ["msp_version"] = "MSP-Version",
        ["credits"] = "Wichtige Mitwirkende, sowohl an der ofs3-Firmware als auch an dieser Software sind: Petri Mattila, Egon Lubbers, Rob Thomson, Rob Gayle, Phil Kaighin, Robert Burrow, Keith Williams, Bertrand Songis, Venbs Zhou... und viele weitere, die Stunden mit Tests und Feedback verbracht haben!",
      ...
      ["servos"] = {
        ...
        ["help_default_p2"] = "Primaere Flugsteuerungen, die den ofs3-Mischer verwenden, werden im Abschnitt 'Mischer' angezeigt.",
