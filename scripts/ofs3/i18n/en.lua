...
return {
  ...
  ["app"] = {
    ...
    ["btn_cancel"] = "CANCEL",
    ["msg_connecting_to_fbl"] = "Connecting...",
    ["navigation_help"] = "?",
    ["modules"] = {
      ["settings"] = {
        ["name"] = "Settings",
      ...
      ["profile_governor"] = {
        ...
        ["disabled_message"] = "ofs3 governor is not enabled",
      ...
      ["about"] = {
        ...
        ["opener"] = "ofs3 is an open source project. Contribution from other like minded people, keen to assist in making this software even better, is welcomed and encouraged. You do not have to be a hardcore programmer to help.",
        ["version"] = "Version",
        ["msp_version"] = "MSP Version",
        ["credits"] = "Notable contributors to both the ofs3 firmware and this software are: Petri Mattila, Egon Lubbers, Rob Thomson, Rob Gayle, Phil Kaighin, Robert Burrow, Keith Williams, Bertrand Songis, Venbs Zhou... and many more who have spent hours testing and providing feedback!",
