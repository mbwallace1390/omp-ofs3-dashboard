  ...
  ["app"] = {
    ...
    ["modules"] = {
      ...
      ["profile_governor"] = {
        ...
        ["disabled_message"] = "ofs3 governor is niet aangezet",
      ...
      ["about"] = {
        ...
        ["opener"] = "ofs3 is een open source project. Bijdragen van andere mensen, die graag willen helpen deze software nog beter te maken, zijn welkom en worden aangemoedigd. Je hoeft geen hardcore programmeur te zijn om te helpen.",
        ["version"] = "Versie",
        ["msp_version"] = "MSP Versie",
        ["credits"] = "Bekende personen die aan de ofs3-firmware en deze software hebben bijgedragen zijn: Petri Mattila, Egon Lubbers, Rob Thomson, Rob Gayle, Phil Kaighin, Robert Burrow, Keith Williams, Bertrand Songis, Venbs Zhou... en nog veel meer mensen die urenlang hebben getest en feedback hebben gegeven!",
