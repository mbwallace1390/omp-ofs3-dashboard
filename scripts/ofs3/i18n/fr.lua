  ...
  ["app"] = {
    ...
    ["modules"] = {
      ...
      ["profile_governor"] = {
        ...
        ["disabled_message"] = "Le gouverneur ofs3 n'est pas active",
      ...
      ["about"] = {
        ...
        ["opener"] = "ofs3 est un projet open source. Toute contribution de personnes partageant le meme etat d'esprit, desireuses d'ameliorer encore ce logiciel, est la bienvenue et encouragee. Vous n'avez pas besoin d'etre un programmeur experimente pour aider.",
        ["version"] = "Version",
        ["msp_version"] = "Version MSP",
        ["credits"] = "Les contributeurs notables au firmware ofs3 et a ce logiciel sont : Petri Mattila, Egon Lubbers, Rob Thomson, Rob Gayle, Phil Kaighin, Robert Burrow, Keith Williams, Bertrand Songis, Venbs Zhou... et bien d'autres qui ont passe des heures a tester et fournir des retours !",
