--[[
  ...
  Note: the navigation/ah "artificial horizon" box below is a
  stylistic HUD backdrop, not a live flight instrument - this
  dashboard's telemetry table does not track attitude/GPS sensors
  (attpitch/attroll/attitude/groundspeed), so it always renders
  level/idle. Real telemetry (RPM, fuel, voltage, RSSI, timers) is
  all live, same as the other themes.
]] --
...
local colorMode = assert(loadfile("SCRIPTS:/" .. ofs3.config.baseDir .. "/widgets/dashboard/themes/@cockpit/palette.lua"))()
...
local themeOptions = {
    ...
    ls_full = {font = "FONT_XXL", thickness = 16, valuepaddingtop = 40, gaugepadding = 20},

    ls_std = {font = "FONT_XL", thickness = 14, valuepaddingtop = 5, gaugepadding = 10},

    ms_full = {font = "FONT_XXL", thickness = 14, valuepaddingtop = 5, gaugepadding = 10},

    ms_std = {font = "FONT_XL", thickness = 10, valuepaddingtop = 10, gaugepadding = 5},

    ss_full = {font = "FONT_XL", thickness = 12, valuepaddingtop = 5, gaugepadding = 10},

    ss_std = {font = "FONT_XL", thickness = 10, valuepaddingtop = 10, gaugepadding = 10}
}
...
local function buildBoxes(W)
    ...
    return {

        {
            ...
            arccolor = colorMode.textcolor,
            laddercolor = colorMode.textcolor,
            compasscolor = colorMode.textcolor,
            crosshaircolor = colorMode.textcolor
        },
        {col = 1, row = 7, colspan = 4, rowspan = 2, type = "text", subtype = "telemetry", source = "rpm", nosource = "-", unit = "", transform = "floor", title = "@i18n(widgets.dashboard.theme_headspeed)@", titlepos = "bottom", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor},
        {col = 5, row = 7, colspan = 4, rowspan = 2, type = "text", subtype = "telemetry", source = "profile", title = "@i18n(widgets.dashboard.theme_profile)@", titlepos = "bottom", transform = "floor", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor}, {
            col = 9,
            row = 7,
            colspan = 6,
            rowspan = 2,
            type = "time",
            subtype = "flight",
            title = "@i18n(widgets.dashboard.theme_time)@",
            titlepos = "bottom",
            titlecolor = colorMode.titlecolor,
            textcolor = colorMode.textcolor,
            bgcolor = colorMode.bgcolor
        }, {col = 15, row = 7, colspan = 6, rowspan = 2, type = "text", subtype = "telemetry", source = "rssi", nosource = "-", unit = "dB", title = "@i18n(widgets.dashboard.theme_lq)@", titlepos = "bottom", transform = "floor", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor}, {
            type = "gauge",
            subtype = "arc",
            col = 9,
            row = 1,
