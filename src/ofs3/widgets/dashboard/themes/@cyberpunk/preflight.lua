...
-- Razor thin gauge strokes - a fraction of @rt-rc/@neon's thickness.
local themeOptions = {

    ls_full = {font = "FONT_XXL", thickness = 8, valuepaddingtop = 40, gaugepadding = 20},

    ls_std = {font = "FONT_XL", thickness = 7, valuepaddingtop = 5, gaugepadding = 10},

    ms_full = {font = "FONT_XXL", thickness = 7, valuepaddingtop = 5, gaugepadding = 10},

    ms_std = {font = "FONT_XL", thickness = 5, valuepaddingtop = 10, gaugepadding = 5},

    ss_full = {font = "FONT_XL", thickness = 6, valuepaddingtop = 5, gaugepadding = 10},

    ss_std = {font = "FONT_XL", thickness = 5, valuepaddingtop = 10, gaugepadding = 10}
}
...
local function buildBoxes(W)
    ...
    return {
        ...
        {col = 1, row = 4, colspan = 8, rowspan = 3, type = "text", subtype = "telemetry", source = "rpm", nosource = "-", unit = "", transform = "floor", title = "@i18n(widgets.dashboard.theme_headspeed)@", titlepos = "bottom", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor},
        {col = 1, row = 7, colspan = 4, rowspan = 2, type = "text", subtype = "telemetry", source = "profile", title = "@i18n(widgets.dashboard.theme_profile)@", titlepos = "bottom", transform = "floor", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor},
        {col = 5, row = 7, colspan = 4, rowspan = 2, type = "time", subtype = "count", title = "@i18n(widgets.dashboard.theme_flights)@", titlepos = "bottom", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor},
        {col = 9, row = 7, colspan = 6, rowspan = 2, type = "time", subtype = "flight", title = "@i18n(widgets.dashboard.theme_time)@", titlepos = "bottom", titlecolor = colorMode.titlecolor, textcolor = colorMode.textcolor, bgcolor = colorMode.bgcolor},
