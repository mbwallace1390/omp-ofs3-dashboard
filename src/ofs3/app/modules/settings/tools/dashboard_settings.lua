...
local function openPage(pidx, title, script)
    ...
    ofs3.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.dashboard)@" .. " / " .. "@i18n(app.modules.settings.dashboard_settings)@")
    ...
    if ofs3.app.gfx_buttons["settings_dashboard_themes"] == nil then ofs3.app.gfx_buttons["settings_dashboard_themes"] = {} end
    if ofs3.preferences.menulastselected["settings_dashboard_themes"] == nil then ofs3.preferences.menulastselected["settings_dashboard_themes"] = 1 end
    ...
    for idx, theme in ipairs(themeList) do
        ...
        if theme.configure then
            ...
            if not theme.configure then ofs3.app.formFields[idx]:enable(false) end

            if ofs3.preferences.menulastselected["settings_dashboard_themes"] == idx then ofs3.app.formFields[idx]:focus() end
