...
local function openPage(pageIdx, title, script)
    ...
    ofs3.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.txt_development)@")
    ...
    ofs3.app.formFields[formFieldCount] = form.addBooleanField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, function() if ofs3.preferences and ofs3.preferences.developer then return settings['devtools'] end end,
                                              function(newValue) if ofs3.preferences and ofs3.preferences.developer then settings.devtools = newValue end end)
    ...
    ofs3.app.formFields[formFieldCount] = form.addChoiceField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, {{"@i18n(app.modules.settings.txt_console)@", 0}, {"@i18n(app.modules.settings.txt_consolefile)@", 1}}, function()
    ...
    ofs3.app.formFields[formFieldCount] = form.addChoiceField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, {{"@i18n(app.modules.settings.txt_off)@", 0}, {"@i18n(app.modules.settings.txt_info)@", 1}, {"@i18n(app.modules.settings.txt_debug)@", 2}}, function()
        if ofs3.preferences and ofs3.preferences.developer then
    ...
    ofs3.app.formFields[formFieldCount] = form.addBooleanField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, function() if ofs3.preferences and ofs3.preferences.developer then return settings['memstats'] end end,
                                              function(newValue) if ofs3.preferences and ofs3.preferences.developer then settings.memstats = newValue end end)
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(settings) do ofs3.preferences.developer[key] = value end
