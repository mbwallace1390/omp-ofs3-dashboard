...
local function openPage(pageIdx, title, script)
    ...
    ofs3.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.audio)@" .. " / " .. "@i18n(app.modules.settings.txt_audio_events)@")
    ...
    for i, v in ipairs(eventList) do
        ...
        ofs3.app.formFields[formFieldCount] = form.addBooleanField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, function() if ofs3.preferences and ofs3.preferences.events then return settings[v.sensor] end end,
                                                  function(newValue) if ofs3.preferences and ofs3.preferences.events then settings[v.sensor] = newValue end end)
    end
...
local function onNavMenu()
    ...
    ofs3.app.ui.openPage(pageIdx, "@i18n(app.modules.settings.name)@", "settings/tools/audio.lua")
end
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(settings) do ofs3.preferences.events[key] = value end
