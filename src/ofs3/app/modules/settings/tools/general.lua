...
local function openPage(pageIdx, title, script)
    ...
    ofs3.app.ui.fieldHeader("@i18n(app.modules.settings.name)@" .. " / " .. "@i18n(app.modules.settings.txt_general)@")
    ...
    ofs3.app.formLines[ofs3.session.formLineCnt] = form.addLine("@i18n(app.modules.settings.txt_iconsize)@")
    ofs3.app.formFields[formFieldCount] = form.addChoiceField(ofs3.app.formLines[ofs3.session.formLineCnt], nil, {{"@i18n(app.modules.settings.txt_text)@", 0}, {"@i18n(app.modules.settings.txt_small)@", 1}, {"@i18n(app.modules.settings.txt_large)@", 2}}, function()
        if ofs3.preferences and ofs3.preferences.general and ofs3.preferences.general.iconsize then
            return settings.iconsize
        else
            return 1
        end
    end, function(newValue) if ofs3.preferences and ofs3.preferences.general then settings.iconsize = newValue end end)
    ...
    local buttons = {
        {
            ...
            action = function()
                ...
                for key, value in pairs(settings) do ofs3.preferences.general[key] = value end
